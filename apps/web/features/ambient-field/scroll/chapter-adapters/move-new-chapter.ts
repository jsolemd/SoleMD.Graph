...
export const moveNewChapterAdapter: ChapterAdapter = (element, options) => {
  const viewport = element.querySelector<HTMLElement>("[data-move-new-viewport]");
  const track = element.querySelector<HTMLElement>("[data-move-new-track]");
