...
Recreate the Maze homepage baseline lifecycle inside `apps/web/features/field`
...
- [ ] Later module reveals should be field-led:
  ...
  stay owned by the field rather than by a large static DOM block
