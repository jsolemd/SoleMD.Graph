...
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA solemd TO solemd;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA pubtator TO solemd;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA solemd GRANT ALL ON SEQUENCES TO solemd;
ALTER DEFAULT PRIVILEGES IN SCHEMA pubtator GRANT ALL ON SEQUENCES TO solemd;
