...
import { ToggleCompare } from "@/features/wiki/module-runtime/interactions";
import { useToggleCompareContext } from "@/features/wiki/module-runtime/interactions/ToggleCompare/ToggleCompare";
  ...
  return (
    ...
    >
      ...
      <Text
        size="xs"
        mt="sm"
        style={{ color: "var(--feedback-danger-text)", fontStyle: "italic" }}
      >
