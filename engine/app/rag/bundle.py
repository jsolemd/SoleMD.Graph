...
def assemble_evidence_bundles(
    ...
    *,
    ...
    authors: dict[int, list[PaperAuthorRecord]],
        ...
        bundles.append(
            EvidenceBundle(
                ...
                rank_features={
                    ...
                    "passage_structure": paper.passage_structure_score,
