...
export const COLUMNS: ColumnMeta[] = [
  ...
  },
  {
    ...
    facetName: 'text_availability',
    label: 'Text Availability',
    type: 'categorical',
  },
  { key: 'isOpenAccess', label: 'Open Access', type: 'categorical' },
  { key: 'hasOpenAccessPdf', label: 'Open PDF', type: 'categorical' },
  {
    key: 'semanticGroups',
    facetName: 'semantic_groups_csv',
    label: 'Entity Groups',
    type: 'categorical',
  },
  {
    key: 'relationCategories',
    facetName: 'relation_categories_csv',
  ...
  { key: 'paperRelationCount', label: 'Paper Relations', type: 'numeric' },
  ...
  { key: 'topEntities', label: 'Top Entities', type: 'text' },
