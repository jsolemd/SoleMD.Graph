...
/**
 * Shared "graph workspace unavailable" card. Used by both /map and /graph
 * when the active bundle fetch fails or returns null. Centralized so the
 * two routes don't drift on copy or styling.
 */
export function GraphBundleUnavailable() {
  return (
    <main
