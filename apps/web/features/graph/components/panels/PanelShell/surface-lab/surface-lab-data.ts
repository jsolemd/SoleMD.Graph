...
export const tokenWallGroups = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { label: "Accent Border", token: "--mode-accent-border" },
  ...
  },
  {
    ...
    tokens: [
      ...
      { label: "Control Hover", token: "--graph-control-hover-bg" },
      { label: "Control Pressed", token: "--graph-control-pressed-bg" },
      { label: "Control Active", token: "--graph-control-active-bg" },
    ],
  },
  {
