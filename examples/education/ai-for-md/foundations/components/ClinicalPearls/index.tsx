...
export function ClinicalPearls({ className = '' }: ClinicalPearlsProps) {
  // Stub: sleep data hook was removed; these counts are placeholders until rebuild
  const sleepData = { processScenarios: {}, neurotransmitters: { scenarios: [] }, glymphatic: { presets: [] } };
