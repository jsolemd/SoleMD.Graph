...
function createControllerState(): CreateEditorControllerState {
  return {
    ...
    evidenceAssistMenuRef: { current: null },
    evidenceAssistMenu: null,
    closeEvidenceAssistMenu: jest.fn(),
    handleEvidenceAssistMenuHover: jest.fn(),
    handleEvidenceAssistMenuKeyDown: jest.fn(),
    handleSourceTextChange: jest.fn(),
    submitEvidenceAssistIntent: jest.fn(),
    flush: jest.fn(() => ""),
    getText: jest.fn(() => ""),
  };
}
