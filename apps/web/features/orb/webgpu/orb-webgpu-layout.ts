...
export const RENDER_POSITION_INDEX = 4;
export const RENDER_ATTRIBUTE_INDEX = 5;
export const RENDER_FLAG_INDEX = 6;
export const RENDER_FRAME_INDEX = 7;
export const PICK_POSITION_INDEX = 8;
export const PICK_FRAME_INDEX = 9;
...
export const FRAME_UNIFORM_BYTES = 32;
